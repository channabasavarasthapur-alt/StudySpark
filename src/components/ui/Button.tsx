...
export function Button({
  ...
  const variants = {
    primary: 'bg-foreground text-background shadow-sm shadow-foreground/10 hover:bg-foreground/90',
    secondary: 'bg-purple text-purple-foreground shadow-sm shadow-purple/20 hover:bg-purple/90',
    outline: 'border border-border bg-card text-foreground shadow-sm shadow-foreground/5 hover:border-purple/30 hover:bg-purple/5',
    ghost: 'text-muted hover:text-foreground hover:bg-foreground/5',
    glass: 'border border-border bg-card text-foreground shadow-sm shadow-foreground/5 hover:bg-background',
